...
--if campon == "true" then
	...
	freeswitch.consoleLog("notice", "Progress_evento campon no atendimento.: ".. tostring(uuid).." "  .. tostring(campon) .. "\n");
	freeswitch.consoleLog("notice", "Progress_evento call_uuid no atendimento.: " .. tostring(uuid).." " .. tostring(call_uuid) .. "\n");
	freeswitch.consoleLog("notice", "Progress_evento uuid no atendimento.: " .. tostring(uuid) .. "\n");
	freeswitch.consoleLog("notice", "Progress_evento destination_number no atendimento.: " .. tostring(uuid) .." " .. tostring(destination_number) .. "\n");
	freeswitch.consoleLog("notice", "Progress_evento variavel signal_bond no atendimento.: " .. tostring(uuid) .." " .. tostring(signal_bond) .. "\n");
	freeswitch.consoleLog("notice", "Progress_evento variavel endpoint_disposition no atendimento.: ".. tostring(uuid) .." " .. tostring(endpoint_disposition) .. "\n");
